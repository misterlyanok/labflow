...
export interface Lesson { id: string; subjectId: string; subject?: string; title: string; date: string; startTime: string; endTime: string; teacher?: string; room?: string; registration: RegistrationStatus }
